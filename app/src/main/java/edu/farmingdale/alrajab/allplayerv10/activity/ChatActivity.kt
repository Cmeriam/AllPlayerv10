...
import edu.farmingdale.alrajab.allplayerv10.adapter.MessageAdapter
import edu.farmingdale.alrajab.allplayerv10.databinding.ActivityChatBinding
import java.util.*
        ...
        binding.imageView2.setOnClickListener {
            ...
            if (binding.messageBox.text.isEmpty()) {
                ...
                val message = MessageModel(
                    binding.messageBox.text.toString(), senderUid, Date().time
                )
